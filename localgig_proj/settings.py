"""
Django settings for localgig_proj project.
...
SECRET_KEY = 'django-insecure-#w@3ahs-)v8q-2iovi3n2%1v!!r19*eon^g1jl(7gdc4(5wvhy'
...
ROOT_URLCONF = 'localgig_proj.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'builtins': [
                'jobs_app.templatetags.custom_filters',
            ],
        },
    },
]

WSGI_APPLICATION = 'localgig_proj.wsgi.application'
